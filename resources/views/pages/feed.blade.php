            ...
            <div class="feed__wrapper">
                ...
                <header class="post__header post__author">
                  <a class="post__author-link" href="#" title="Автор">
                    <div class="post__avatar-wrapper">
                      <img class="post__author-avatar" src="{{ asset('img/userpic-elvira.jpg') }}" alt="Аватар пользователя" width="60" height="60">
                    </div>
              ...
              <article class="feed__post post post-video">
                <header class="post__header post__author">
                  <a class="post__author-link" href="#" title="Автор">
                    <div class="post__avatar-wrapper">
                      <img class="post__author-avatar" src="{{ asset('img/userpic-petro.jpg') }}" alt="Аватар пользователя">
                    </div>
                    <div class="post__info">
              ...
              <article class="feed__post post post-quote">
                <header class="post__header post__author">
                  <a class="post__author-link" href="#" title="Автор">
                    <div class="post__avatar-wrapper">
                      <img class="post__author-avatar" src="{{ asset('img/userpic-mark.jpg') }}" alt="Аватар пользователя">
                    </div>
                    <div class="post__info">
              ...
              <article class="feed__post post post-link">
                <header class="post__header post__author">
                  <a class="post__author-link" href="#" title="Автор">
                    <div class="post__avatar-wrapper">
                      <img class="post__author-avatar" src="{{ asset('img/userpic-larisa.jpg') }}" alt="Аватар пользователя">
                    </div>
                    <div class="post__info">
                  ...
                  <div class="post-link__wrapper">
                    <a class="post-link__external" href="http://www.vitadental.ru" title="Перейти по ссылке">
                      <div class="post-link__icon-wrapper">
                        <img src="{{ asset('img/logo-vita.jpg') }}" alt="Иконка">
                      </div>
