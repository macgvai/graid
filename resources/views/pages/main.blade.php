          ...
          <nav class="header__nav">
            <ul class="header__user-nav page__user-nav">
              <li class="page__user-item">
                ...
                <a class="header__user-button header__register-button button button--transparent" href="{{ route('registration') }}">Регистрация</a>
              </li>
            </ul>
          </nav>
        </div>
    ...
    <main>
      ...
      <div class="page__main-wrapper page__main-wrapper--intro container">
        ...
        <section class="authorization">
          ...
          <form class="authorization__form form" action="http://localhost:8081/api/login" method="post">
