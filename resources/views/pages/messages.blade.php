          ...
          <ul class="messages__contacts-list tabs__list">
            <li class="messages__contacts-item">
              <a class="messages__contacts-tab messages__contacts-tab--active tabs__item tabs__item--active" href="#">
                <div class="messages__avatar-wrapper">
                  <img class="messages__avatar" src="{{ asset('img/userpic-larisa.jpg') }}" alt="Аватар пользователя">
                </div>
            ...
            <li class="messages__contacts-item messages__contacts-item--new">
              <a class="messages__contacts-tab tabs__item" href="#">
                <div class="messages__avatar-wrapper">
                  <img class="messages__avatar" src="{{ asset('img/userpic-petro.jpg') }}" alt="Аватар пользователя">
            ...
            <li class="messages__contacts-item">
              <a class="messages__contacts-tab tabs__item" href="#">
                <div class="messages__avatar-wrapper">
                  <img class="messages__avatar" src="{{ asset('img/userpic-mark.jpg') }}" alt="Аватар пользователя">
                </div>
                <div class="messages__info">
                  <span class="messages__contact-name">
                    Марк Смолов
            ...
            <li class="messages__contacts-item">
              <a class="messages__contacts-tab tabs__item" href="#">
                <div class="messages__avatar-wrapper">
                  <img class="messages__avatar" src="{{ asset('img/userpic-tanya.jpg') }}" alt="Аватар пользователя">
                </div>
                <div class="messages__info">
                  <span class="messages__contact-name">
                    Таня Фирсова
            ...
            <ul class="messages__list tabs__content tabs__content--active">
                ...
                <div class="messages__info-wrapper">
                  <div class="messages__item-avatar">
                    <a class="messages__author-link" href="#">
                      <img class="messages__avatar" src="{{ asset('img/userpic-larisa-small.jpg') }}" alt="Аватар пользователя">
                    </a>
                  </div>
              ...
              <li class="messages__item messages__item--my">
                <div class="messages__info-wrapper">
                  <div class="messages__item-avatar">
                    <a class="messages__author-link" href="#">
                      <img class="messages__avatar" src="{{ asset('img/userpic.jpg') }}" alt="Аватар пользователя">
                    </a>
                  </div>
                  <div class="messages__item-info">
                    <a class="messages__author" href="#">
