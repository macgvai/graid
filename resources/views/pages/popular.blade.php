              ...
              <div class="post__author">
                <a class="post__author-link" href="#" title="Автор">
                  <div class="post__avatar-wrapper">
                    <img class="post__author-avatar" src="{{ asset('img/userpic-larisa-small.jpg') }}" alt="Аватар пользователя">
                  </div>
            ...
            <div class="post__main">
              <div class="post-video__block">
                <div class="post-video__preview">
                  <img src="{{ asset('img/coast-medium.jpg') }}" alt="Превью к видео" width="360" height="188">
                </div>
          ...
          <article class="popular__post post post-photo">
            ...
            <div class="post__main">
              <div class="post-photo__image-wrapper">
                <img src="{{ asset('img/rock-medium.jpg') }}" alt="Фото от пользователя" width="360" height="240">
              </div>
            </div>
            <footer class="post__footer">
              <div class="post__author">
