        ...
        <div class="header__nav-wrapper">
          <nav class="header__nav">
            ...
            <ul class="header__user-nav">
              ...
              <li>
                <a class="header__post-button button button--transparent" href="{{ route('adding-post') }}">Пост</a>
              </li>
            </ul>
          </nav>
        </div>
          ...
          <div class="profile__user user container">
            <div class="profile__user-info user__info">
              <div class="profile__avatar user__avatar">
                <img class="profile__picture user__picture" src="{{ asset('img/userpic-medium.jpg') }}" alt="Аватар пользователя">
              </div>
                ...
                <article class="profile__post post post-photo">
                  ...
                  <div class="post__main">
                    <div class="post-photo__image-wrapper">
                      <img src="{{ asset('img/rock.jpg') }}" alt="Фото от пользователя" width="760" height="396">
                    </div>
                  </div>
                ...
                <article class="profile__post post post-text">
                    ...
                    <div class="post__author">
                      <a class="post__author-link" href="#" title="Автор">
                        <div class="post__avatar-wrapper post__avatar-wrapper--repost">
                          <img class="post__author-avatar" src="{{ asset('img/userpic-tanya.jpg') }}" alt="Аватар пользователя">
                        </div>
                        ...
                        <li class="comments__item user">
                          <div class="comments__avatar">
                            <a class="user__avatar-link" href="#">
                              <img class="comments__picture" src="{{ asset('img/userpic-larisa.jpg') }}" alt="Аватар пользователя">
                            </a>
                          </div>
                  ...
                  <form class="comments__form form" action="#" method="post">
                    <div class="comments__my-avatar">
                      <img class="comments__picture" src="{{ asset('img/userpic.jpg') }}" alt="Аватар пользователя">
                    </div>
                ...
                <ul class="profile__likes-list">
                  <li class="post-mini post-mini--photo post user">
                    <div class="post-mini__user-info user__info">
                      <div class="post-mini__avatar user__avatar">
                        <a class="user__avatar-link" href="#">
                          <img class="post-mini__picture user__picture" src="{{ asset('img/userpic-petro.jpg') }}" alt="Аватар пользователя">
                        </a>
                      </div>
                    ...
                    <div class="post-mini__preview">
                      <a class="post-mini__link" href="#" title="Перейти на публикацию">
                        <div class="post-mini__image-wrapper">
                          <img class="post-mini__image" src="{{ asset('img/rock-small.png') }}" width="109" height="109" alt="Превью публикации">
                        </div>
                  ...
                  <li class="post-mini post-mini--video post user">
                    ...
                    <div class="post-mini__preview">
                      <a class="post-mini__link" href="#" title="Перейти на публикацию">
                        <div class="post-mini__image-wrapper">
                          <img class="post-mini__image" src="{{ asset('img/coast-small.png') }}" width="109" height="109" alt="Превью публикации">
